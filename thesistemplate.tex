...
\degreeprogram{Automation and Robotics}
%%
...
%% 
\thesistitle{AI Natives in the Loop: Orchestrating Autonomous Agent Swarms for Global Tech Expeditions }
...
%% by a regular space.
%%
\supervisor{Prof.\ Pekka Forsman} %{Prof.\ Pirjo Professori}
...
\advisor{D.Sc.\ (Tech.) Zhao Rongzhen}
...
%% Avainsanat
%%
\keywords{Multi-Agent Systems, Agent Swarm Orchestration, Local Large Language Models, Tool-Calling Agents, WebAssembly Sandboxing}
%% Abstract text
...
\thesistitle{AI-natiivit osana prosessia: Autonomisten agenttiparvien koordinointi globaaleilla teknologia-tutkimusretkill }
\advisor{ Zhao Rongzhen}
\degreeprogram{Electronics and electrical engineering}

%% Avainsanat
\keywords{Moniagenttijärjestelmät, Agenttiparvien ohjaus, Paikalliset kielimallit, Autonomiset tekoälyagentit, Tekoälyn hiekkalaatikointi}
...
\vspace{5mm}
{\hfill Lukas A.\ B.\ Engineer \hspace{1cm}}
